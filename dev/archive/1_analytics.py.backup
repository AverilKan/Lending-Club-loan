...
# ## Introduction
#
# This phase establishes the analytical foundation for independent credit risk modeling through comprehensive exploratory data analysis (EDA) of the Lending Club dataset. Building upon business intelligence requirements, this analysis will define an enhanced target variable representing credit risk, establish a validated risk hierarchy for feature prioritization, assess historical portfolio trends, and identify critical preprocessing strategies for the subsequent modeling phase.
#
...
# - Create robust preprocessing framework for independent model development
...
# %% [markdown]
# **Findings (Target Correlation Analysis):**
# *   **Primary Risk Driver:** `int_rate` (correlation: 0.230) emerges as the strongest predictor, validating that current interest rate pricing appropriately reflects loan risk levels.
# *   **Credit Quality Indicators:** FICO scores show expected negative correlation (-0.122), confirming their predictive value for default risk assessment.
# *   **Financial Stress Signals:** DTI ratio (0.059) and revolving utilization (0.040) show positive correlations, indicating borrower financial stress leads to higher default rates.
# *   **Loan Characteristics:** Loan amount (0.050) and installment (0.052) show modest positive correlations, suggesting larger loans carry incrementally higher risk.
# *   **Account Activity Patterns:** Recent account openings and inquiries show positive correlations, indicating credit-seeking behavior correlates with default risk.
# *   **Business Implications:** The correlation hierarchy provides clear guidance for risk-based pricing and underwriting decisions, with interest rate serving as the primary risk discriminator.
